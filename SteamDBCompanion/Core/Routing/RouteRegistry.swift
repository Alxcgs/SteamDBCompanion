...
public extension RouteRegistry {
    static let defaultDescriptors: [RouteDescriptor] = [
        ...
        RouteDescriptor(path: "/app/:id", title: "App Overview", mode: .native, group: .app),
        ...
        RouteDescriptor(path: "/events", title: "Events", mode: .webFallback, group: .utility),
        RouteDescriptor(path: "/year", title: "Year in Review", mode: .webFallback, group: .utility),
        RouteDescriptor(path: "/login", title: "Steam Login", mode: .webFallback, group: .utility),
        RouteDescriptor(path: "/wishlist", title: "Steam Wishlist", mode: .webFallback, group: .utility),
        RouteDescriptor(path: "/news", title: "Steam News", mode: .webFallback, group: .utility),
